    ...
    return declare(PluginBase, {
        ...
        initialize: function (frameworkParameters) {
            ...
            this.blockGroupSelectedSymbol = new SimpleFillSymbol(
                    ...
                    new SimpleLineSymbol(
                            SimpleLineSymbol.STYLE_SOLID,
                            new Color([19,165,80, 1]), //color
                            3 //width
                            ),
                    new Color([255, 255, 255, 0]) //white, completely transparent
                    );
            
            //reoder array - use for reordering legend
            //see https://stackoverflow.com/questions/2440700/reordering-arrays/2440723
        ...
        activate: function () {
            ...
            if (!this.activated) {
                ...
                //Roads
                if (this.regionConfig.service && !this.layers.roads) {
                    this.layers.roads = new ArcGISDynamicMapServiceLayer(this.regionConfig.service, {
                        id: 'roads',
                        visible: false
                    });
                    this.layers.roads.setVisibleLayers([this.regionConfig.roads_ServiceIndex]);
...
//                this.map.addLayer(this.layers.townFL);
        ...
        render: function () {
            ...
            this.$el.html(_.template(template)({
                ...
                roads: Number.isInteger(this.regionConfig.roads_ServiceIndex),
            ...
            this.map.on("extent-change", lang.hitch(this, function(){
                ...
                if ( this.map.getScale() <100000){
                    ...
                    $("#barriersCheck").attr("disabled", true);
                    $("#roadsCheck").attr("disabled", true);
                }
            }));
...
//					},
            ...
            //turn off SVI layer group by default
...
//            }));
        ...
        loadTownsSuccess: function (queryResults) {
            ...
            this.townNames = this.townNames.sort();
        },
        /** 
...
//								$("#custom-handle").html(val + '%'); 
                            ...
                            highVal = 0;
                            if (highValFieldName)
                                this.$el.find("#metric_" + highValFieldName).parent().parent().addClass('hilite');
...
//                            roadTwnValue = "--";
//                            addyTwnValue = "--";
                            this.$el.find("#metric_costToRoad").html("--");
                            this.$el.find("#metric_numAddy").html("--");
